...
const MediaRunningContainerForSafari: FC<
  MediaRunningContainerForSafariProps
> = ({ className = "" }) => {
  ...
  const renderLeft = (post: PostDataType) => {
    ...
    return (
      ...
      >
        ...
        <div className="hidden md:flex flex-shrink-0 px-6 dark text-white space-x-2.5"></div>
      </div>
    );
  };
